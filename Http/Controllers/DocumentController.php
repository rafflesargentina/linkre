...
use Raffles\Modules\Linkre\Repositories\DocumentRepository;
...
class DocumentController extends ApiResourceController
{
    protected $repository = DocumentRepository::class;
